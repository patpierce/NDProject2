...
public class FavoritesProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // for URI = content://com.example.android.pjpopmovies2/favorites/
            case CODE_FAVORITES: {
            ...
            // for URI like content://com.example.android.pjpopmovies2/favorites/12345
            ...
            // for URI like content://com.example.android.pjpopmovies2/reviews/12345
            ...
            // for URI = content://com.example.android.pjpopmovies2/videos/
            case CODE_VIDEOS: {
                cursor = mOpenHelper.getReadableDatabase().query(
            ...
            // for URI like content://com.example.android.pjpopmovies2/videos/12345
